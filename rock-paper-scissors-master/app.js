...
const showFight = () => {
    ...
    document.querySelector(".result-button").setAttribute("tabindex", 0);
...
const createPickElement = (option) => {
    ...
    imageContainerElement.classList.add("button-imeges-container");
...
const reset = () => {
    ...
    document.querySelector(".result-button").setAttribute("tabindex", -1);
};
